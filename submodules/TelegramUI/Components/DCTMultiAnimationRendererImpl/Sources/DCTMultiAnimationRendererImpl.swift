...
public final class DCTMultiAnimationRendererImpl: MultiAnimationRenderer {
    ...
    public static let firstFrameQueue = Queue(name: "DCTMultiAnimationRenderer-FirstFrame", qos: .userInteractive)
